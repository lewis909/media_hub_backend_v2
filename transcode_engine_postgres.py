    ...
    try:
        if xml:
            ...
            for file in xml:
                ...
                sql_conform = "UPDATE asset_db_task SET status ='Conforming' WHERE id='" + task_id + "'"
                ...
                sql_transcode = "UPDATE asset_db_task SET status ='Transcoding' WHERE id='" + task_id + "'"
                ...
                if task_state == 'complete':
                    ...
                    sql_complete = "UPDATE asset_db_task SET status ='Complete' WHERE id='" + task_id + "'"
                    cursor.execute(sql_complete)
                    dbc.commit()
                    job_complete_time = time.ctime()
                    # Updated database stating task completion time
                    end_job = "UPDATE asset_db_task SET job_end_time ='" + job_complete_time + "'WHERE id='" + task_id + "'"
                    ...
                    # Updated database stating that the task has completed
                    sql_error = "UPDATE asset_db_task SET status ='Error' WHERE id='" + task_id + "'"
